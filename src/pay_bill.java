...
public class pay_bill extends JFrame implements ActionListener {
    ...
    JTextField customerIdField, mbpSecField;
    JComboBox<String> monthComboBox; // Changed to a JComboBox
    ...
    public void actionPerformed(ActionEvent ae) {
        if (ae.getSource() == searchButton) {
            ...
            String customerId = customerIdField.getText();
            String month = (String) monthComboBox.getSelectedItem(); // Get the selected month
            ...
            try {
                ...
                if (resultSet.next()) {
                    ...
                    String query = "INSERT INTO bill (customer_id, name, month, amount) VALUES ('" + customerId + "','" + customerName + "', '" + month + "', " + amount + ")";

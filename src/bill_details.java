...
public class bill_details extends JFrame implements ActionListener {
        ...
        t1.addMouseListener(new MouseAdapter() {
            public void mouseClicked(MouseEvent me) {
                ...
                if (row != -1) {
                    ...
                    openUpdateBillDetails(customerId, month);
                }
            }
        });
    }
    ...
    public void openUpdateBillDetails(String customerId, String month) {
        EventQueue.invokeLater(() -> {
            try {
                UpdateBillDetails frame = new UpdateBillDetails(customerId, month);
